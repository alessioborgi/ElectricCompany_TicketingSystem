...
$query=" SELECT * FROM Tecnici WHERE Username_Tecnico = '$username' AND Password_Tecnico ='$password';";
...
if($row = mysqli_fetch_assoc($risultato)){
            ...
            alert(" You are Logged in! Welcome in ELECTROSERVICE HelpDesk")
...
?>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <h1 class="display-4 text-center">Technicians Area</h1>
                    </div>
                        <div class="jumbotron col-sm-6" style="background-color:lavender;">
                         <table>
                        <tr>
                            <td>
                                <form method="post" action="Gestisci_Ticket.php">
                                    <br>
                                    &emsp; &emsp;  &emsp; &emsp;  &emsp; &emsp;  &emsp; &emsp;<input type="submit" class="btn" value="Ticket Management"></input>
                                </form>
                            </td>
                            </tr>
                            <tr>
                            <td>
                                <form method="post" action="Ticket_Gestiti.php">
                                    <br>
                                    &emsp; &emsp; &emsp; &emsp; &emsp; &emsp;  &emsp; &emsp; <input type="submit" class="btn" value=" Managed Ticket"></input>
                                </form>
                            </td>
                        </tr>
                        </table>
