...
?>   
            <div class="container">
                ...
                <div class="row">
                    ...
                    <h1 class="display-4 text-center">Technicians Reports <Area></Area></h1>
                    </div>
                        <div class="jumbotron col-sm-6" style="background-color:lavender;">
                         <table>
                        <tr>
                            <td>
                                <form method="post" action="Aggiungi_Report.php"> 
                                    <br>
                                    <?php
                                    echo '<input type="hidden" name="Usr" value="' . $Usr . '">';
                                    ?>
                                    &emsp; &emsp; &emsp; &emsp;  &emsp; &emsp; &emsp; &emsp;  <input type="submit" class="btn" value="Add Report"></input> &emsp;  &emsp;  &emsp; 
                                </form>
                            </td>
                            </tr>
                            <tr>
                            <td>
                                <form method="post" action="Visiona_Report.php">
                                    <br>
                                    <?php
                                    echo '<input type="hidden" name="Usr" value="' . $Usr . '">';
                                    ?>
                                    &emsp; &emsp;  &emsp; &emsp;  &emsp; &emsp; &emsp; &emsp; <input type="submit" class="btn" value="Review Report"></input>
                                </form>
                            </td>
                        </tr>
                        </table>
