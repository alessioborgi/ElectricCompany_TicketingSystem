...
<div class="container">
                ...
                <h1 class="display-6 text-center">ELECTROSERVICE Clients<br> Closed Ticket Area</h1>
    ...
    //Query sul Database. 
    $query = "select * from tickets where Data_Chiusura != '0000-00-00';";
    ...
    while ($row = mysqli_fetch_array($result))
        {
            ...
            <form method="post" action="Visiona_Report.php">
                ...
                ?>
                &emsp;<input type="submit" class="btn" value="Reports"></input>
            </form>
            </td>
            <?php
            echo "</tr>";
